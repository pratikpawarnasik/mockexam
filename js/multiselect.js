(function () {
    ...
    angular.module("long2know").run(["$templateCache", function ($templateCache) {
        $templateCache.put("template/multiselect/multiselectPopup.html",
            "<div class=\"\" ng-class=\"{ dropup: dropup, single: !multiple }\">" +
                "<button type=\"button\" class=\"dashboard_select_btn dropdown-toggle\" ng-click=\"toggleSelect()\" ng-disabled=\"disabled\">" +
